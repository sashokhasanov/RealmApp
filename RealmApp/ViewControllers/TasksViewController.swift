...
class TasksViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let doneAction = UIContextualAction(style: .normal, title: doneTitle) { _, _, isDone in
            ...
            tableView.moveRow(at: indexPath, to: self.getIndexPath(of: task))
            isDone(true)
        }
    ...
    private func getTask(by indexPath: IndexPath) -> Task {
        switch indexPath.section {
        case 0:
            return currentTasks[indexPath.row]
        default:
    ...
    private func getIndexPath(of task: Task) ->IndexPath {
        let row = task.isComplete ? completedTasks.index(of: task) : currentTasks.index(of: task)
